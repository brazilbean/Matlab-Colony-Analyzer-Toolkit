%% Colony Perimeter - measure the diameter of the middle colony
% Gordon Bean, May 2013

function d = colony_perimeter( plate, grid, ii )
    ...
    stats = regionprops(bbox, 'Centroid', 'Perimeter');
